...
export class Hero implements AfterViewInit, OnDestroy {
  ...
  currentRole = '';
private roles = [
  '3+ years delivering end-to-end solutions, from architecture to deployment, using Angular (standalone), C#, .NET, Node.js APIs, and SQL.',
  ...
  'Focused on performance, clean architecture, secure maintainable systems, deployment automation and operational reliability.'
];
